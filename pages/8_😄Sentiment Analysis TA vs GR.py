...
st.set_page_config(page_title="Comparative Sentiment Analysis of Reviews of Touristic Sites in Lebanon Trip Advisor vs Google Reviews",
                   page_icon="🏛️",
                   layout="wide")


st.title("Comparative Sentiment Analysis of Reviews of Touristic Sites in Lebanon between Trip Advisor vs Google Reviews")


#*****************************************************************************************************#

reviews_4a = get_tripadvisor_reviews("final_trip_advisor_reviews_sa.csv")

reviews_4b = get_googlemaps_reviews("final_google_reviews_sa.csv")
...
with attraction_one_cell:
    ...
    attraction_box_one = selection_box(reviews_4a, "attraction", "attraction from Trip Advisor:", disable_box= False)

    reviews_queried_one = reviews_4a.query("attraction==@attraction_box_one")



with attraction_two_cell:

    attraction_box_two = selection_box(reviews_4b, "attraction", "attraction from Google Reviews:", disable_box= False)

    reviews_queried_two = reviews_4b.query("attraction==@attraction_box_two")
