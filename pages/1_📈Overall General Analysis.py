...
tab1, tab2, tab3, tab4, tab5 = st.tabs(
    ["Attractions with the Most Number of Reviews", "Attractions with the Least Number of Reviews",
     "Reviews per Governorate", "Reviews per Category", "Attraction Rating vs Number of Ratings"])

with tab1:
    with st.container():
        if dataset_selected == "Trip Advisor":
            attractions_horiz_barchart = plot_horiz_group_barchart_google(attractions_df.tail(10), "attraction",
                                                                          "total_ratings",
...
with tab2:
    with st.container():
        if dataset_selected == "Trip Advisor":
            attractions_horiz_barchart = plot_horiz_group_barchart_google(attractions_df.head(10), "attraction",
                                                                          "total_ratings",
