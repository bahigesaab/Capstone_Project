...
st.set_page_config(page_title="Comparative Text Analysis of Reviews of Touristic Sites in Lebanon Trip Advisor vs Google Reviews",
                   page_icon="🌃",
                   layout="wide")
...
reviews_5a = get_tripadvisor_reviews("final_trip_advisor_reviews_tm_nouns.csv")

reviews_5b = get_googlemaps_reviews("final_google_reviews_tm.csv")
...
with attraction_one_cell:
    ...
    attraction_box_one = selection_box(reviews_5a, "attraction", "attraction from Trip Advisor:", disable_box= False)

    reviews_queried_one = reviews_5a.query("attraction==@attraction_box_one")


with attraction_two_cell:

    attraction_box_two = selection_box(reviews_5b, "attraction", "attraction from Google Reviews:", disable_box= False)

    reviews_queried_two = reviews_5b.query("attraction==@attraction_box_two")
